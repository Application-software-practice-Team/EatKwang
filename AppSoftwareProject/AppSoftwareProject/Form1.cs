    ...
    public partial class Form1 : Form
    {
        ...
        {   
            ...
            {   
                ...
                tempImage = new Bitmap(Properties.Resources.roullette8);
            }
            else if (num == 7)
            {
                originalImage = new Bitmap(Properties.Resources.roullette7);
                tempImage = new Bitmap(Properties.Resources.roullette7);
            }
            else if (num == 6)
            {   
                originalImage = new Bitmap(Properties.Resources.roullette6);
                tempImage = new Bitmap(Properties.Resources.roullette6);
            }
            else if (num == 5)
            {
                originalImage = new Bitmap(Properties.Resources.roullette5);
                tempImage = new Bitmap(Properties.Resources.roullette5);
            }
            else if (num == 4)
            {
                originalImage = new Bitmap(Properties.Resources.roullette4);
                tempImage = new Bitmap(Properties.Resources.roullette4);
            }
            else if (num == 3)
            {   
                originalImage = new Bitmap(Properties.Resources.roullette3);
                tempImage = new Bitmap(Properties.Resources.roullette3);
            }
            else if (num == 2)
            {   
                originalImage = new Bitmap(Properties.Resources.roullette2);
                tempImage = new Bitmap(Properties.Resources.roullette2);
            }
        }
